...
PALETTES = {
    ...
    # A lit redstone lamp. Entry 0 stays the amber world.cpp already names for
    # this material — it is what the block fades to at distance and what its
    # particles are made of — and the rest of the ramp is the lamp: dark frame,
    # warm body, and a hot core in each pane.
    "torch":   [(252,178,56),(148, 90,26),(255,226,150),(104, 60,14),
                (232,158,44),(244,198, 98),(255,246,208),(186,116,32)],
    ...
    # Gems in a stone matrix, exactly as iron and coal are built: entries 1, 2
    # and 7 are the host rock, and 3..6 are the ore itself. Entry 0 is the cyan
    # world.cpp names, kept off the face on purpose -- it is the distance and
    # particle colour, and a block that is already flat cyan up close has
    # nowhere left to go when the fog takes it.
    "diamond": [(110,232,228),(112,116,122),(136,140,146),(86,206,204),
                (150,246,242),(58,150,152),(198,252,250),(100,104,110)],
}
...
TEXTURES = {
    ...
    "bedrock": """
        ...
        2703127031270312
    """,
    # Four small rhombi in plain rock. Deliberately sparser than iron's
    # scatter: a diamond face should read as a find, not as a texture.
    "diamond": """
        1122112211221122
        1122112211221122
        2211621122112211
